...
--%>
            <script language="javascript">
                function test (id) {
                    $.ajax({
                        type: "Delete",
                        url: "${pageContext.request.contextPath}/management/gonggaolan/index?id="+id,
                        success: function () {
                            window.location.href="${pageContext.request.contextPath}/management/gonggaolan/index";
                        },
                        error: function () {
                            window.location.href="${pageContext.request.contextPath}/management/gonggaolan/index";
                        }
            ...
            <div class="row">
                <div class="col-12 col-lg-12 col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="management/gonggaolan/index" method="post">
