            ...
            <div class="row pt-2 pb-2">
                <div class="col-sm-9">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javaScript:void();">管理账户</a></li>
            ...
            <div class="row">
                <div class="col-12 col-lg-12 col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="management/saveaddadmin" method="post">
                                <div class="form-group row">
                                    <label for="input-21" class="col-sm-2 col-form-label">用户名</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="input-21" name="name" placeholder="用户名">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="input-22" class="col-sm-2 col-form-label">密码</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="input-22" name="password" placeholder="密码">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="input-23" class="col-sm-2 col-form-label">管理员工等级</label>
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" id="input-23" name="level" placeholder="管理员工等级">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label"></label>
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-default px-5"></i>提交</button>
                                    </div>
                                </div>
                            </form>
                        </div>
