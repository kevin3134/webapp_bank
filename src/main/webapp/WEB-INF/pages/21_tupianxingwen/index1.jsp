...
--%>
            <script language="javascript">
                function test (id) {
                    $.ajax({
                        type: "Delete",
                        url: "${pageContext.request.contextPath}/management/tupianxingwen/index?id="+id,
                        success: function () {
                            window.location.href="${pageContext.request.contextPath}/management/tupianxingwen/index";
                        },
                        error: function () {
                            window.location.href="${pageContext.request.contextPath}/management/tupianxingwen/index";
                        }
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="example" class="table table-bordered">
                                    ...
                                    <c:forEach items="${list}" var="fileData">
                                        <tr>
                                            <td>${fileData.id}</td>
                                            <td>${fileData.title}</td>
                                            <td>${fileData.txtdata}</td>
                                            <td>${fileData.time}</td>
                                            <td>${fileData.fileName}</td>
                                            <td>${fileData.fileType}</td>
                                            <td>
                                                <button type="button" class="btn btn-outline-dark btn-xs" onclick="test(${fileData.id})">删除</button>
                                            </td>
                                        </tr>
                                    </c:forEach>
            ...
            <div class="row">
                <div class="col-12 col-lg-12 col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="management/tupianxingwen/index" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label for="input-22" class="col-sm-2 col-form-label">选择文件</label>
                                    <div class="col-sm-10">
                                        <input type="file" class="form-control" name="upload" id="input-23" placeholder="选择文件">
                                    </div>
                                </div>
